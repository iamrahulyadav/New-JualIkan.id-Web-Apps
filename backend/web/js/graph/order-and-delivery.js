...
function displayDelivery(id){
    $.ajax({
        type : "GET",
        data : "",
        url : "http://ishom.jagopesan.com/jualikan.id/backend/web/api/graph/order-delivery.php?id=" + id,
    ...
    $.ajax({
        type : "GET",
        data : "",
        url : "http://ishom.jagopesan.com/jualikan.id/backend/web/api/graph/order-delivery-price.php?id=" + id,
        success : function(result){
            var resultObj = JSON.parse(result);
...
function displayDeliveryAll(){
    $.ajax({
        type : "GET",
        data : "",
        url : "http://ishom.jagopesan.com/jualikan.id/backend/web/api/graph/order-delivery.php",
        success : function(result){
    ...
    $.ajax({
        type : "GET",
        data : "",
        url : "http://ishom.jagopesan.com/jualikan.id/backend/web/api/graph/order-delivery-price.php",
        success : function(result){
            var resultObj = JSON.parse(result);
