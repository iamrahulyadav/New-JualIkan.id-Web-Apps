...
/**
 * UserDriverSearch represents the model behind the search form of `backend\models\UserDriver`.
 */
class UserDriverSearch extends UserDriver
{
    ...
    {
        return [
            [['driver_id', 'driver_koperasi_id', 'driver_vehicle_weight', 'driver_saldo'], 'integer'],
